...
la $a0,msg117	# put msg117 address into a0
	...
	la $a0,msg218	# put msg117 address into a0
	...
	la $a0,msg219	# put msg117 address into a0
...
T7:	bne $s1,7, T8	# if s1 = 7, do these things. Else go to T7no
	...
	la $a0,msginvert	# put msg127 address into a0
...
T8:	bne $s1,8, T9	# if s1 = 7, do these things. Else go to T7no

	move $a0, $s0

	jal display_reverse_order_recursively
	
	la $a0,msginvertdisplay	# put msg127 address into a0
...
msgreverselist: .asciiz "The reversed linked list is as follows:\n"
msginvert: .asciiz "The linked list has been inverted \n"
...
msg218:	 .asciiz "7 - invert the linked list \n"

msg219:  .asciiz "8 - display the linked list in reverse order \n"
...
msginvertdisplay: .asciiz "The inverted linked list has been displayed\n"
